...
public class Constant {
    ...
    public static final String CACHEIMAGEPATH = Environment.getExternalStorageDirectory().getAbsolutePath() + "/qatime_teacher/images";
    ...
    public static int REQUEST_RECORRECTION = 0x1018;
