...
public class FragmentPersonalCenter extends BaseFragment implements View.OnClickListener {
    ...
    private int[] menuRes = {R.mipmap.center_class_table, R.mipmap.center_my_live, R.mipmap.center_my_interact, R.mipmap.center_my_video, R.mipmap.center_my_exclusive};
