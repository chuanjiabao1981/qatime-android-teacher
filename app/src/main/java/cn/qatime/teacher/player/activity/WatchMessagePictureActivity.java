...
import cn.qatime.teacher.player.utils.AttachmentStore;
import cn.qatime.teacher.player.utils.BitmapDecoder;
import cn.qatime.teacher.player.utils.Constant;
import cn.qatime.teacher.player.utils.ImageUtil;
import cn.qatime.teacher.player.view.BaseZoomableImageView;
import cn.qatime.teacher.player.view.ImageGestureListener;
...
public class WatchMessagePictureActivity extends BaseActivity {
    ...
    private void setImageView(final IMMessage msg) {
        ...
        Bitmap bitmap = BitmapDecoder.decodeSampledForDisplay(this, path, false);
    ...
    private void setThumbnail(IMMessage msg) {
        ...
        if (!TextUtils.isEmpty(thumbPath)) {
            bitmap = BitmapDecoder.decodeSampledForDisplay(this, thumbPath);
